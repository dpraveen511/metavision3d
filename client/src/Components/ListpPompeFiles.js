...
import DisplayPompeFile from './DisplayPompeFile.js';
...
function ListPompeFiles() {
    ...
    return (
        <div >
            ...
            <DisplayPompeFile fileName={selectedFile} smooth={smoothness}
