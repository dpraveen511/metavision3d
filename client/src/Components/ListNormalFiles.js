...
import DisplayNormalFile from './DisplayNormalFile.js';
...
function ListNormalFiles() {
    ...
    return (
        <div >
            ...
            <DisplayNormalFile fileName={selectedFile} smooth={smoothness}
...
export default ListNormalFiles;
