...
function DisplayAlzemiersFile(props) {
  ...
  return (
    <div class = "container ">
      ...
      <div class="header">Diseased Brain</div>
          ...
          <div id="demo3" className="p-2" style={{ height: '400px',width:'49%'}}>
              <canvas id="gl3" style={{width: '500px', height: '400px'}}> </canvas>
          </div>
          <div style={{width: '25px',backgroundColor:'white'}}></div>
          <div id="demo4" className="p-2" style={{ left:'70%',height: '400px',width:'49%',}}>
...
export default DisplayAlzemiersFile